...
import header from "../../../assets/images/stands/biomarin/BANNER1.jpg";
// import logoInterno from "../../../assets/images/stands/puc/logo-interno.png";
import carrusel1 from "../../../assets/images/stands/biomarin/BANNER2.jpg";
import carrusel2 from "../../../assets/images/stands/biomarin/BANNER3.jpg";
	...
	return (
		<div className="stand-xl-container">
			...
			<div className="description-container">
				<h1 className="title">Biomarin</h1>
				<p className="description">
					Descarte una MPS gratis, fácil y con toma de muestra incluida en cualquier localidad de Chile, 
			...
			{visible ? (
				<div className="video-container">
					<iframe
						...
						height="360"
						className="video"
						src="https://player.vimeo.com/video/611731570?h=baa8a8fb64&autoplay=1&loop=1&autopause=0"
						frameBorder="0"
			...
			<div className="buttons-container">
				...
				<button className="wsp" onClick={() => openWsp("56968485514")}>
					WhatsApp
				</button>
				<button className="info" onClick={() => openFile("Problemas cardiorrespiratorios_CL.pdf")}>
