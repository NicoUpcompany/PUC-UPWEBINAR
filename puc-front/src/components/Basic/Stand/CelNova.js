...
import carrusel1 from "../../../assets/images/stands/celNova/banner1.jpg";
import carrusel2 from "../../../assets/images/stands/celNova/banner2.jpg";
import carrusel3 from "../../../assets/images/stands/celNova/banner3.jpg";
import carrusel4 from "../../../assets/images/stands/celNova/banner4.jpg";
import carrusel5 from "../../../assets/images/stands/celNova/banner5.jpg";
...
const CelNova = (props) => {
	...
	const openFile = (file) =>{
		window.open(`https://puc.upwebinar.cl/api/v1/file/${file}`, "_blank")
	}
	...
	return (
		<div className="stand-xl-container">
			...
			<div className="description-container">
				<h1 className="title">Celnova Pharma</h1>
			...
			<div className="carousel-container">
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						<LazyLoadImage alt="Carousel 1" src={carrusel1} width="100%" effect="blur" onClick={() => window.open("https://innovacion.celnova.com/hubfs/Untitled-8-01.jpg", "_blank")}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 2" src={carrusel2} width="100%" effect="blur" onClick={() => window.open("https://innovacion.celnova.com/es-ar/blog-fibrosis-quistica", "_blank")}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 3" src={carrusel3} width="100%" effect="blur" onClick={() => window.open("https://innovacion.celnova.com/hubfs/Zoteon_mailing%20V6-01%20final%20(2).jpg", "_blank")}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 4" src={carrusel4} width="100%" effect="blur" onClick={() => window.open("https://innovacion.celnova.com/hubfs/Zoteon_mailing%20V6-01%20final%20(2).jpg", "_blank")}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 5" src={carrusel5} width="100%" effect="blur" onClick={() => window.open("https://innovacion.celnova.com/hubfs/Untitled-8-01.jpg", "_blank")}/>
					</div>
				</Carousel>
			</div>
