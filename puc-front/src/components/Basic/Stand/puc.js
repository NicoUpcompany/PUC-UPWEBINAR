...
import header from "../../../assets/images/stands/puc/header.jpg";
import logoInterno from "../../../assets/images/stands/puc/logo-interno.png";
import carrusel1 from "../../../assets/images/stands/puc/carrusel1.jpg";
import carrusel2 from "../../../assets/images/stands/puc/carrusel2.jpg";
import carrusel3 from "../../../assets/images/stands/puc/carrusel3.jpg";
import carrusel4 from "../../../assets/images/stands/puc/carrusel4.jpg";
import carrusel5 from "../../../assets/images/stands/puc/carrusel5.jpg";
	...
	return (
		<div className="stand-xl-container">
			...
			<div className="description-container">
				<h1 className="title">Escuela de Ingeniería UC</h1>
				<p className="description">
					Educación Profesional de la Escuela de Ingeniería UC, ofrece programas de cursos y diplomados multidisciplinarios y de gran
					impacto en la empresa y sociedad, en más de 20 áreas de especialización.
				</p>
			</div>
			{visible ? (
				<div className="video-container">
					<iframe
						...
						height="315"
						className="video"
						src="https://player.vimeo.com/video/579447061?autoplay=1&loop=1&autopause=0"
						frameBorder="0"
			...
			<div className="carousel-container">
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						<LazyLoadImage alt="Carousel 1" src={carrusel1} width="100%" effect="blur" onClick={() => window.open("https://bit.ly/3rA68kT", "_blank")}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 2" src={carrusel2} width="100%" effect="blur" onClick={() => window.open("https://bit.ly/3rA68kT", "_blank")}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 3" src={carrusel3} width="100%" effect="blur" onClick={() => window.open("https://bit.ly/3rA68kT", "_blank")}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 4" src={carrusel4} width="100%" effect="blur" onClick={() => window.open("https://bit.ly/3rA68kT", "_blank")}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 5" src={carrusel5} width="100%" effect="blur" onClick={() => window.open("https://bit.ly/3rA68kT", "_blank")}/>
					</div>
				</Carousel>
			</div>
			...
			<div className="footer-container">
				...
				<a href="mailto:programas@ing.puc.cl">programas@ing.puc.cl</a>
				<a href="tel:+56933530870">+56933530870</a>
			</div>
			<Dialog
				open={open}
