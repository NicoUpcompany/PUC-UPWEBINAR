...
import header from "../../../assets/images/stands/biomerieux/header.PNG";
// import logoInterno from "../../../assets/images/stands/puc/logo-interno.png";
import carrusel1 from "../../../assets/images/stands/biomerieux/banner1.png";
import carrusel2 from "../../../assets/images/stands/biomerieux/banner2.png";
import carrusel3 from "../../../assets/images/stands/biomerieux/banner3.png";
import carrusel4 from "../../../assets/images/stands/biomerieux/banner4.JPG";
	...
	return (
		<div className="stand-xl-container">
			...
			<div className="description-container">
				<h1 className="title">Biomerieux</h1>
			...
			<div className="carousel-container">
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						...
						onClick={() => window.open("https://booth.biomerieux-usa.com/", "_blank")}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 2" src={carrusel2} width="100%" effect="blur" onClick={() => window.open("https://www.biofiredx.com/ ", "_blank")}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 3" src={carrusel3} width="100%" effect="blur" onClick={() => window.open("https://lounge.biomerieuxconnection.com/", "_blank")}/>
					</div>
				</Carousel>
			</div>
			...
			<div className="footer-container">
				<a href=" https://lounge.biomerieuxconnection.com/" target="_blank" rel="noreferrer">
					lounge.biomerieuxconnection.com
				</a>
				<a href="mailto:cotizaciones.cl@biomerieux.com">cotizaciones.cl@biomerieux.com </a>
				<a href="tel:+56958245295">+569 58245295</a>
			</div>
			<Dialog
				open={open}
