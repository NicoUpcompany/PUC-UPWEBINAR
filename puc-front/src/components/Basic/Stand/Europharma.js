...
import header from "../../../assets/images/stands/europharma/header.jpg";
// import logoInterno from "../../../assets/images/stands/puc/logo-interno.png";
import carrusel1 from "../../../assets/images/stands/europharma/banner1.jpg";
import carrusel2 from "../../../assets/images/stands/europharma/banner2.jpg";
import carrusel3 from "../../../assets/images/stands/europharma/banner3.jpg";
	...
	return (
		<div className="stand-xl-container">
			...
			<div className="description-container">
				<h1 className="title">Europharma</h1>
			...
			<div className="carousel-container">
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						<LazyLoadImage alt="Carousel 1" src={carrusel1} width="100%" effect="blur" onClick={() => window.open("https://eurofarma.cl/", "_blank")}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 2" src={carrusel2} width="100%" effect="blur" onClick={() => window.open("https://eurofarma.cl", "_blank")}/>
					</div>
				</Carousel>
			</div>
			<div className="buttons-container">
				<button className="info-2" onClick={() => window.open("https://www.eurofarma.cl/artigos")}>
					Descargar información
				</button>
				<button className="wsp" onClick={() => openWsp("56987467267")}>
					WhatsApp
				</button>
			...
			<div className="footer-container">
				<a href="https://www.eurofarma.cl/" target="_blank" rel="noreferrer">
					www.eurofarma.cl
				</a>
				<a href="mailto:euroatiende@eurofarma.cl">euroatiende@eurofarma.cl </a>
				<a href="tel:++56932383615">224831600</a>
			</div>
			<Dialog
				open={open}
