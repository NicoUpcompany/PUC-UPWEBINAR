...
import header from "../../../assets/images/stands/pasteur/header.jpg";
// import logoInterno from "../../../assets/images/stands/puc/logo-interno.png";
import carrusel1 from "../../../assets/images/stands/pasteur/banner1.jpg";
import carrusel2 from "../../../assets/images/stands/pasteur/banner2.jpg";
import carrusel3 from "../../../assets/images/stands/pasteur/banner3.png";
import carrusel4 from "../../../assets/images/stands/pasteur/banner4.jpg";
import carrusel5 from "../../../assets/images/stands/pasteur/banner5.jpg";
		...
		<div className="stand-xl-container">
			...
			{visible ? (
				<div className="video-container">
					<iframe
						...
						height="360"
						className="video"
						src="https://player.vimeo.com/video/617073948?h=dadae80696&autoplay=1&loop=1&autopause=0"
						frameBorder="0"
			...
			<div className="carousel-container">
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						<LazyLoadImage alt="Carousel 1" src={carrusel1} width="100%" effect="blur" onClick={() => openFile('Visual Bersen.pdf')}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 2" src={carrusel2} width="100%" effect="blur" onClick={() => openFile('Visual Bonavid Vitde.pdf')}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 3" src={carrusel3} width="100%" effect="blur" onClick={() => openFile('Visual Fisiolimp.pdf')}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 4" src={carrusel4} width="100%" effect="blur" onClick={() => openFile('Visual Monkast.pdf')}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 5" src={carrusel5} width="100%" effect="blur" onClick={() => openFile('Visual SynAller.pdf')}/>
					</div>
				</Carousel>
			</div>
