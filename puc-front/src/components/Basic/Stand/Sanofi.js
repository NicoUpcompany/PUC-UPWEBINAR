...
import header from "../../../assets/images/stands/sanofi/header.jpg";
// import logoInterno from "../../../assets/images/stands/puc/logo-interno.png";
import carrusel1 from "../../../assets/images/stands/sanofi/banner1.jpg";
import carrusel2 from "../../../assets/images/stands/sanofi/banner2.jpg";
import carrusel3 from "../../../assets/images/stands/sanofi/banner3.jpg";
	...
	return (
		<div className="stand-xl-container">
			...
			<div className="description-container">
				<h1 className="title">Sanofi</h1>
				<p className="description">
					En el siguiente video, descubrí como actúa DUPIXENT en los pacientes con asma grave no controlada y como ayuda a mejorar notablemente la calidad de vida de las personas
				</p>
			</div>
			{visible ? (
				<div className="video-container">
					<iframe
						...
						height="360"
						className="video"
						src="https://player.vimeo.com/video/623463616?h=fcefe959ab&autoplay=1&loop=1&autopause=0"
						frameBorder="0"
			...
			<div className="carousel-container">
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						<LazyLoadImage alt="Carousel 1" src={carrusel1} width="100%" effect="blur" onClick={() =>openFile('Dupixent Ayuda Visual Chile  DG-PRINT (2) (1).pdf')}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 2" src={carrusel2} width="100%" effect="blur" onClick={() =>openFile('QUEST CHILE DG-PRINT (1).pdf')}/>
					</div>
					<div className="image">
						<LazyLoadImage alt="Carousel 3" src={carrusel3} width="100%" effect="blur" onClick={() =>openFile('VENTURE CHILE DG-PRINT (1).pdf')}/>
					</div>
				</Carousel>
			</div>
