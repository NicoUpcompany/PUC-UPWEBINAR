...
import { HomeOutlined, UserOutlined, HistoryOutlined, ClockCircleOutlined, QuestionOutlined, TagOutlined, ScheduleOutlined, SettingOutlined } from '@ant-design/icons';
            ...
            <Menu theme="dark" mode="inline" defaultSelectedKeys={[location.pathname]}>
                ...
                <Menu.Item key="/dashboard/opciones">
                    <Link to={"/dashboard/opciones"}>
                        <SettingOutlined />
                        <span className="nav-text">Encuesta y evaluación</span>
                    </Link>
                </Menu.Item>
            </Menu>
        </Sider>
