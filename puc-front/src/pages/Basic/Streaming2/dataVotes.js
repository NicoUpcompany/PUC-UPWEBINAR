export const dataVotes = [
    ...
    },
    {
        id: 15,
        num: 'question15',
        ask: 'Considerando los antecedentes del niño, ¿cuál de las siguientes terapias le parece mas razonable?',
        alt1: 'Terapia de rescate con salbutamol y corticoides sistémicos',
        alt2: 'Terapia con Budesonida + formoterol en MDI Intermitente',
        alt3: 'Terapia con corticoides inhalados en dosis crecientes mas antileucotrienos si no logra control ',
        alt4: 'Antileucotrienos permanente + salbutamol de rescate'
    },
    {
        id: 16,
        num: 'question16',
        ask: 'Que otras alternativas terapéuticas tenemos frente a un paciente de 5 años que a pesar de terapia no responde al uso de CI + LABA + LTRA ?',
        alt1: 'Agregar un anti muscarinico de acción prolongada ( LAMA ) como Tiotropio',
        alt2: 'Evaluar uso de terapias biológicas como omalizumab o dupilumab',
        alt3: 'Cambiar a una asociación de budesonida + fomoterol',
        alt4: 'Ninguna de las anteriores'
    },
    {
        id: 17,
        num: 'question17',
    ...
    },
    {
        id: 20,
        num: 'question20',
        ask: '¿Qué estudio podría ser de utilidad para confirmar la sospecha de complicaciones?',
    ...
    },
    {
        id: 21,
        num: 'question21',
        ask: '¿Cómo interpreta estas imágenes D1 y D2?',
        alt1: 'Liquido libre (D1) y septos/lóculos (D2)',
        alt2: 'Líquido libre (D1 y D2)',
        alt3: 'Septos/lóculos (D1 y D2)',
        alt4: 'Las imágenes no son específicas de derrame'
    },
    {
        id: 22,
        num: 'question22',
        ask: '¿Cuál sería el tratamiento de elección en este paciente?',
        alt1: 'Tratamiento antibiótico EV prolongado',
        alt2: 'Iniciar fibrinolíticos',
        alt3: 'Video toracoscopía (VATS)',
        alt4: 'Cirugía abierta convencional'
    },
    {
        id: 23,
        num: 'question23',
        ask: '¿Cuándo sería apropiado considerar solicitar TAC pulmonar?',
    ...
    },
    {
        id: 24,
        num: 'question24',
        ask: '¿Cuál es el diagnóstico inicial mas probable?',
        alt1: 'a)Rinofaringitis viral',
        alt2: 'b)Neumonía de la comunidad',
        alt3: 'c)Bronquiolitis aguda',
        alt4: 'd)Sibilancias recurrentes'
    },
    {
        id: 25,
        num: 'question25',
    ...
    },
    {
        id: 29,
        num: 'question29',
        ask: 'En relación a la relación de los virus y la humanidad ¿cuál de las siguientes le parece más razonable?',
        alt1: 'Las epidemias mejoran la inmunidad humana',
        alt2: 'Las epidemias mejoran el DNA humano',
        alt3: 'Las epidemias son parte de un ciclo biológico natural',
        alt4: 'Las epidemias aumentan con el cambio climático'
    },
    {
        id: 30,
        num: 'question30',
